            ...
            <div className="container main-content mt-5 pt-4">
                <div className="welcome-banner text-center py-5 mb-4 rounded position-relative overflow-hidden">
                    <div className="welcome-content">
                        <h1 className="display-4 mb-3">Welcome back, {localStorage.getItem('userName')}! 👋</h1>
                        <p className="lead mb-4">Ready to continue your learning journey?</p>
                        <div className="stats-container d-flex justify-content-center gap-4">
                            ...
                            <div className="stat-item">
                                <div className="stat-value">{courseStats.averageProgress}%</div>
                ...
                <div className="quick-actions mb-5">
                    <div className="row g-4">
                        <div className="col-md-4">
                            <div className="quick-action-card" onClick={() => document.querySelector('input[type="text"]').focus()}>
                        ...
                        <div className="col-md-4">
                            <div className="quick-action-card" onClick={() => navigate('/instructor-chats')}>
                        ...
                        <div className="col-md-4">
                            <div className="quick-action-card" onClick={() => setShowCreateModal(true)}>
